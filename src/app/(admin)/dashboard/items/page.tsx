...
import { ItemsManagementTable } from "@/components/admin/items-management-table"
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-2">Filter, review, and update the status of reported items.</p>
      </div>
